...
<div class="page">
        ...
        <div class="flex flex-col items-center py-5">
            <div class="w-full">
                <div class="w-3/4 m-auto">
                    <img src="dist/assets/images/aboutBanner.png" alt="">
                </div>
            </div>
            <div class="w-full">
                ...
                <p class="open-sans text-[24px] text-black">Get the best exchange rates for currency exchange, forex cards, and money transfers from India. Quick, simple, and reliable services with RBI-authorized partners! Get the best exchange rates for currency exchange, forex cards, and money transfers from India. Quick, simple, and reliable services with RBI-authorized partners! Get the best exchange rates for currency exchange, forex cards, and money transfers from India. Quick, simple, and reliable services with RBI-authorized partners!
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-theme1 p-3 py-5 md:py-0 md:p-[64px]">
        <div class="container">
            <h2 class="w-full md:w-1/2 mb-3 md:mb-0 text-[42px] md:text-[72px] gadugi-bold text-white title-shadow">About My Forex Rate</h2>
            <div class="flex flex-col md:flex-row items-center">
                <div class="w-full md:w-3/5 pt-5 text-white font-[open-sans] text-[24px]">Get the best exchange rates for currency exchange, forex cards, and money transfers from India. Quick, simple, and reliable services with RBI-authorized partners! Get the best exchange rates for currency exchange, forex cards, and money transfers from India. Quick, simple, and reliable services with RBI-authorized partners!</div>
                <div class="w-full md:w-2/5 pt-5 md:pt-0">
                    <img class="w-full max-w-[300px] m-auto md:ml-auto" src="./dist/assets/images/logoWhite.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8">
                <div class="w-full md:w-2/3">
                    <div class="flex items-center px-4 py-2 md:py-3 border-[6px] border-[#001E3769] mb-6 md:mb-[46px] rounded-full">
                        <img class="w-[68px] md:w-[100px] mr-3" src="./dist/assets/images/wwp-1.png" alt="">
                        <div class="text-theme1">
                            <div class="mb-2 text-lg gadugi-bold">Marketplace Advantage</div>
                            <p class="text-xs">Being a Forex marketplace, every exchange house here tries to outbid others. Result, you get the best exchange rate in the market!!</p>
                        </div>
                    </div>
                    <div class="flex items-center px-4 py-2 md:py-3 border-[6px] border-[#001E3769] mb-6 md:mb-[46px] rounded-full">
                        <img class="w-[68px] md:w-[100px] mr-3" src="./dist/assets/images/wwp-2.png" alt="">
                        <div class="text-theme1">
                            <div class="mb-2 text-lg gadugi-bold">Marketplace Advantage</div>
                            <p class="text-xs">Being a Forex marketplace, every exchange house here tries to outbid others. Result, you get the best exchange rate in the market!!</p>
                        </div>
                    ...
                    <div class="flex items-center px-4 py-2 md:py-3 border-[6px] border-[#001E3769] mb-6 md:mb-[46px] rounded-full">
                        <img class="w-[68px] md:w-[100px] mr-3" src="./dist/assets/images/wwp-3.png" alt="">
                        <div class="text-theme1">
                            <div class="mb-2 text-lg gadugi-bold">Marketplace Advantage</div>
                            <p class="text-xs">Being a Forex marketplace, every exchange house here tries to outbid others. Result, you get the best exchange rate in the market!!</p>
                        </div>
                ...
                <div class="w-full md:w-2/3 flex justify-center text-center">
                    <div class="w-[290px] h-[290px] md:w-[390px] md:h-[390px] flex justify-center items-center border-[6px] border-[#001E3769] rounded-full">
                        <img class="w-[150px] md:w-[250px]" src="./dist/assets/images/logo-only.svg" alt="">
                    </div>
                </div>
                <div class="w-full md:w-2/3">
                    <div class="flex items-center px-4 py-2 md:py-3 border-[6px] border-[#001E3769] mb-6 md:mb-[46px] rounded-full">
                        ...
                        <img class="w-[68px] md:w-[100px] ml-3" src="./dist/assets/images/wwp-4.png" alt="">
                    </div>
                    <div class="flex items-center px-4 py-2 md:py-3 border-[6px] border-[#001E3769] mb-6 md:mb-[46px] rounded-full">
                        <div class="text-theme1">
                            <div class="mb-2 text-lg gadugi-bold">Marketplace Advantage</div>
                        ...
                        <img class="w-[68px] md:w-[100px] ml-3" src="./dist/assets/images/wwp-5.png" alt="">
                    </div>
                    <div class="flex items-center px-4 py-2 md:py-3 border-[6px] border-[#001E3769] mb-6 md:mb-[46px] rounded-full">
                        <div class="text-theme1">
                            <div class="mb-2 text-lg gadugi-bold">Marketplace Advantage</div>
                        ...
                        <img class="w-[68px] md:w-[100px] ml-3" src="./dist/assets/images/wwp-6.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="p-4 bg-white rounded-[21px] shadow-md">
                        <div class="mb-4 flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <img src="./dist/assets/images/review-img1.png" alt="Item Image" class="w-10 h-10 rounded-full">
                                <div class="">
                                    <h3 class="text-lg gadugi-bold">Slider Item 1</h3>
                                    <span class="text-[10px] px-3 rounded-full bg-[#D9D9D9] text-white gadugi-bold">Money Transfer</span>
                                </div>
                            </div>
                            <div class="mt-2 flex">
                        ...
                        <div>
                            <p class="text-theme1 text-sm open-sans">I’ve been using My Forex Rate for a few months now, and I’m impressed with the overall experience. The platform offers competitive exchange rates and low transaction fees, making it ideal for frequent currency exchanges.</p>
                        </div>
                    </div>
                </div>
                <!-- Slider Item 2 -->
